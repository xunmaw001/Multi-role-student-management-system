                    ...
                    <div class="widget-area-2 lochana-box-shadow">
                        ...
                        <div class="table-responsive mb-3">
                            <div class="col-sm-12">
                                        ...
                                        <label>
                                            考试名称
                                            <input type="text" id="examNameSearch" class="form-control form-control-sm"
                                                   placeholder="" aria-controls="tableId">
                                        </label>
                                 
                                            <label>
                                                科目
                                                <select name="kemuTypesSelectSearch" id="kemuTypesSelectSearch" class="form-control form-control-sm"
                                        ...
                                        <label>
                                            分数
                                            <input type="text" id="fractionStartSearch" onchange="fractionChickValue(this)"   class="form-control " placeholder="开始" aria-controls="tableId">
                                        </label>
                                            -
                                        <label>
                                            <input type="text" id="fractionEndSearch" onchange="fractionChickValue(this)"     class="form-control" placeholder="结束" aria-controls="tableId">
                                        </label>
                                        ...
                                        <label>
                                            身份
                                            <select name="yonghuTypesSelectSearch" id="yonghuTypesSelectSearch" class="form-control form-control-sm"
                                                    aria-controls="tableId">
                                            </select>
                                        </label>
    ...
    //填充级联表搜索下拉框
        ...
        function yonghuTypesSelectSearch() {
            ...
            if(yonghuTypesSelectSearch != null) {
                yonghuTypesSelectSearch.add(new Option('', ''));
    ...
    //填充本表搜索下拉框
        ...
        function kemuTypesSelectSearch() {
            ...
            if(kemuTypesSelectSearch != null) {
                kemuTypesSelectSearch.add(new Option('',''));
