                        ...
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 当前表的字段 -->
                                   ...
                                   <div class="form-group col-md-6">
                                       <label>任务类型</label>
                                       <select id="renwuTypesSelect" name="renwuTypes" class="form-control">
                                       </select>
                                   </div>
                                   <div class="form-group col-md-6">
                                       <label>接收身份</label>
...
<script>
    ...
    function getContent() {
        ...
        if (renwuContentEditor.hasContents()) {
                $('#renwuContent-input').attr('value', renwuContentEditor.getPlainTxt());
        }
    }
    //数字检查
        <!-- 当前表的数字检查 -->
    ...
    function validform() {
        return $("#addOrUpdateForm").validate({
            ...
            messages: {
                renwuTypes: "任务类型不能为空",
                yonghuTypes: "接收身份不能为空",
                renwuContent: "任务内容不能为空",
                insertTime: "发布时间不能为空",
            }
        }).form();
    }
