                    ...
                    <div class="widget-area-2 lochana-box-shadow">
                        ...
                        <div class="table-responsive mb-3">
                            <div class="col-sm-12">
                                        ...
                                        <label>
                                            编码名字
                                            <input type="text" id="indexNameSearch" class="form-control form-control-sm"
...
<script>
    ...
    function setDataRow(item, number) {
        ...
        //父字段id
        var superIdCell = document.createElement('td');
        superIdCell.innerHTML = item.superId;
        row.appendChild(superIdCell);
